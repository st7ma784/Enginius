...
class CarCollectionDataGenerator:
    def __init__(self, seed: int = 42):
        ...
        self.locations = ['Downtown', 'Airport', 'Mall', 'Suburb_North', 'Suburb_South', 'Industrial']
        ...
        self.driver_efficiency = {driver: np.random.normal(1.0, 0.15) for driver in self.drivers}
    ...
    def generate_sample(self, n_samples: int = 1000) -> pd.DataFrame:
        ...
        for _ in range(n_samples):
            ...
            # Checklist factor
            checklist_factor = 1 + (checklist_length - 5) * 0.05  # Each item adds ~3 minutes
            ...
            expected_time = (base_time * time_factor * checklist_factor * 
                           ev_factor * driver_factor * lunch_factor)
    ...
    def get_feature_encodings(self, df: pd.DataFrame) -> Tuple[np.ndarray, Dict]:
        ...
        # Feature matrix
        features = [
            'location_encoded', 'driver_encoded', 'hour', 'checklist_length',
